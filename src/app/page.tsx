      ...
      >
        <Container maxWidth="lg" sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <Box sx={{ display: 'flex', gap: 1 }}>
            <Button component={Link} href="/sign-in" variant="text" size="small" sx={{ color: 'text.secondary' }}>
              Sign In
            </Button>
            <Button component={Link} href="/sign-up" variant="contained" size="small" disableElevation>
              Get Started
            </Button>
          </Box>
        </Container>
      ...
      <Box component="section" sx={{ py: 14, textAlign: 'center', px: 3 }}>
        <Container maxWidth="md">
          ...
          <Box sx={{ display: 'flex', gap: 1.5, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Button component={Link} href="/sign-up" variant="contained" size="large" disableElevation>
              Start for free
            </Button>
